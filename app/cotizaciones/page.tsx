...
import AllQuoteContent from "@/components/AllQuoteContent";

export const metadata: Metadata = {
  title: "Todas las Cotizaciones | Dolaractual.com",
  description: "Lista completa de cotizaciones del dólar, monedas extranjeras y criptomonedas en tiempo real.",
};

// Revalidación ISR: Cada 60 segundos se regenera la página
export const revalidate = 60;

export default async function AllQuotePage() {
  // 1. Obtener todas las cotizaciones normalizadas en el servidor
  // Esta función ya hace Promise.all internamente para Dólar, Fiat y Cripto
  const allQuotes = await getAllQuotesNormalized();

  return (
    <main className="min-h-screen bg-background">
      {/* 2. Pasar los datos al componente de cliente */}
      <AllQuoteContent initialQuotes={allQuotes} />
    </main>
  );
}
