...
export async function GET() {
  try {
    ...
    messages.push(
      `Limpieza Profunda: Se eliminaron ${deleteResult.deletedCount} noticias antiguas.`,
    );
    ...
    return NextResponse.json({
      ...
      messages: messages,
      nextSteps:
        "Revisa la base de datos. Deberías ver una caída drástica en la cantidad de documentos.",
    });
  } catch (error: any) {
